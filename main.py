...
def criaMapa():
    ...
    # Caminho fixo para o arquivo mapa.txt
    caminho_arquivo = "mapa.txt"  # você pode colocar o caminho completo se necessário

    with open(caminho_arquivo, 'r') as arquivo:
        for linha in arquivo:
            linha = linha.strip().split()
            if linha:
                matriz.append([int(elemento) for elemento in linha])
